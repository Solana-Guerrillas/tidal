...
import type { PoolDiscoveryItem } from "@/mock-data/pool/types";

type PoolDiscoveryCardProps = {
  item: PoolDiscoveryItem;
  onResearch: () => void;
  onAddToWatchlist: () => void;
};

export function PoolDiscoveryCard({
  item,
  onResearch,
  onAddToWatchlist,
}: PoolDiscoveryCardProps) {
  return (
